<?php
session_start();
if($_SESSION['status_login2']==false){
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4 bg">
            ...
            <div class="sidebar">
                <div class="user-panel mt-3 pb-3 mb-3 d-flex justify-content-between align-items-center">
                    ...
                    <div class="icont">
                        <a href="#" class="sign-out-link" title="Log Out" data-toggle="modal"
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li
                            class="nav-item <?php echo ($title === 'user' || $title === 'user_create') ? 'menu-open' : ''; ?>">
                            <a href="index.php?page=user&title=user"
                                class="nav-link <?php if($title === 'user' || $title === 'user_create' ){ echo 'active'; } ?>">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="index.php?page=user&title=user"
                                        class="nav-link <?php if($title === 'user') echo 'active'; ?>">
                                ...
                                <li class="nav-item">
                                    <a href="index.php?page=user_create&title=user_create"
                                        class="nav-link <?php if($title === 'user_create') echo 'active'; ?>">
                        ...
                        <li
                            class="nav-item <?php echo ($title === 'pengelola' || $title === 'pengelola_create' ) ? 'menu-open' : ''; ?>">
                            <a href="index.php?page=pengelola&title=pengelola"
                                class="nav-link <?php if($title === 'pengelola' || $title === 'pengelola_create'){ echo 'active'; } ?>">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="index.php?page=pengelola&title=pengelola"
                                        class="nav-link <?php if($title === 'pengelola') echo 'active'; ?>">
                                        <i class="fas fa-database"></i>
                                        <p>Database</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="index.php?page=pengelola_create&title=pengelola_create"
                                        class="nav-link <?php if($title === 'pengelola_create') echo 'active'; ?>">
                                        <i class="fas fa-plus"></i>
                                        <p>Create</p>
                                    </a>
                                </li>
                        ...
                        <li
                            class="nav-item <?php echo ($title === 'barang' || $title === 'barang_create' ) ? 'menu-open' : ''; ?>">
                            <a href="index.php?page=barang&title=barang"
                                class="nav-link <?php if($title === 'barang' || $title === 'barang_create'){ echo 'active'; } ?>">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="index.php?page=barang&title=barang"
                                        class="nav-link <?php if($title === 'barang') echo 'active'; ?>">
                                        <i class="fas fa-database"></i>
                                        <p>Database</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="index.php?page=barang_create&title=barang_create"
                                        class="nav-link <?php if($title === 'barang_create') echo 'active'; ?>">
                                        <i class="fas fa-plus"></i>
                                        <p>Create</p>
                                    </a>
                                </li>
                        ...
                        <!-- <li class="nav-item <?php echo ($title === 'peminjaman' || $title === 'peminjaman_create' || $title === 'peminjaman_edit') ? 'menu-open' : ''; ?>">
                            <a href="index.php?page=peminjaman&title=peminjaman"
                                class="nav-link <?php if($title === 'peminjaman' || $title === 'peminjaman_create' || $title === 'peminjaman_edit'){ echo 'active'; } ?>">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="index.php?page=peminjaman_create&title=peminjaman_create"
                                        class="nav-link <?php if($title === 'peminjaman_create') echo 'active'; ?>">
                                        <i class="fas fa-plus"></i>
                                        <p>Create</p>
                                    </a>
                                </li>
                        ...
                        <li
                            class="nav-item <?php echo ($title === 'pengembalian' || $title === 'pengembalian_create' || $title === 'pengembalian_edit') ? 'menu-open' : ''; ?>">
                            <a href="index.php?page=pengembalian&title=pengembalian"
                                class="nav-link <?php if($title === 'pengembalian' || $title === 'pengembalian_create' || $title === 'pengembalian_edit'){ echo 'active'; } ?>">
